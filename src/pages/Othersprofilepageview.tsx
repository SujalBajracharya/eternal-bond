...
import KundaliCompatibility from "@/components/KundaliCompatibility";
...
type TabKey = "detailed" | "photos" | "kundali";
...
export default function OthersProfilePageView() {
  ...
  return (
    <>
      <NavbarAuthenticated />
      <div className="min-h-screen bg-background pb-24 selection:bg-primary/15 relative overflow-hidden grain">
        {/* Page-level background blobs (cover whole page) */}
        {/* <div className="absolute inset-0 pointer-events-none -z-10">
        <div className="absolute -top-32 -left-32 w-[28rem] h-[28rem] rounded-full bg-gradient-sunset opacity-30 blur-3xl animate-blob" />
        <div className="absolute -bottom-40 -right-32 w-[32rem] h-[32rem] rounded-full bg-gradient-plum opacity-20 blur-3xl animate-blob [animation-delay:2s]" />
        <div className="absolute top-1/3 right-1/4 w-72 h-72 rounded-full bg-gradient-warm opacity-40 blur-3xl animate-blob [animation-delay:4s]" />
      </div> */}

        <header className="relative pb-16 overflow-hidden">
          <div className="mx-auto px-2 sm:px-3 lg:px-4 mb-12">
            <div className="rounded-[8px] overflow-hidden bg-card/80 shadow-soft relative">
              <div className="relative h-[15rem] md:h-[19rem] overflow-hidden bg-primary/5">
                <img
                  src={heroCouple}
                  alt="Illustration"
                ...
                <div className="absolute top-6 left-6">
                  <span className="inline-flex items-center gap-2 rounded-full bg-card/70 px-4 py-1.5 text-xs font-medium uppercase tracking-[0.22em] text-primary border border-border/60 shadow-soft">
        ...
        <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-24 relative z-10 grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="rounded-[24px] bg-gradient-sunset text-primary-foreground p-6 text-center shadow-lg relative overflow-hidden">
              ...
              <div>
                ...
                <button
                  ...
                  className="w-full bg-primary hover:bg-primary-deep text-primary-foreground text-xs uppercase tracking-widest font-bold py-3.5 rounded-xl transition-all duration-300 mt-6 flex items-center justify-center gap-2"
                >
                  KUNDALI READY <ArrowLeft className="w-4 h-4 rotate-180" />
                </button>
              </div>
            </div>
          ...
          <div className="lg:col-span-8 space-y-6">
            {/* Tabs bar */}
            <div className="flex gap-6 items-center border-b border-border/80 pb-3">
              {(["detailed", "photos", "kundali"] as TabKey[]).map((t) => (
                <button
                  key={t}
            ...
            {activeTab === "kundali" && id && (
              <CardWrapper>
                <SectionTitle icon={Compass} title="Kundali Match" />
                <KundaliCompatibility targetProfileId={id} />
              </CardWrapper>
            )}
